-- A year tier represented by one show has an authoritative result order. In
-- particular, normalized point shares must not overturn the declared winner
-- of a final (as happened in 1960). Normalized comparisons remain necessary
-- for tiers containing parallel shows, such as multiple semi-finals.
...
-- Repair already cached rankings, including 1960, during deployment.
