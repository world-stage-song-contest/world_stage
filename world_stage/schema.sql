...
CREATE TABLE session (
    id integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
    user_id integer REFERENCES account (id) ON UPDATE RESTRICT ON DELETE RESTRICT,
    session_id uuid,
    created_at timestamptz DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE country (
    ...
    cc2 text COLLATE public.nocase,
    pot integer,
    priority integer,
...
CREATE TABLE vote (
    ...
    song_id integer REFERENCES song (id) ON UPDATE RESTRICT ON DELETE RESTRICT,
    point_id integer REFERENCES point (id) ON UPDATE RESTRICT ON DELETE RESTRICT,
