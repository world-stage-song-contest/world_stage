...
BEGIN
    ...
    point_counts AS (
        ...
        WHERE
            ...
            OR (
                si.year_id BETWEEN 1965 AND 1978
                AND vs.country_id IS DISTINCT FROM s.country_id
            )
            OR (
                si.year_id >= 0 AND si.year_id < 1965 AND si.year_id <> 1960
                AND vs.country_id IS DISTINCT FROM s.country_id
            )
            OR (
                si.year_id = 1960
    ...
    aggregated AS (
        ...
        GROUP BY
            ...
            si.year_id, si.dtf, si.sc, si.special, vbc.cnt
    ),
    ranked AS (
        SELECT
            a.*,
    ...
    INSERT INTO country_show_results (
        ...
        max_possible_points, points_percentage, entry_status, max_pts,
        ...
        ROUND(
            COALESCE(
                r.total_points::numeric
                    / NULLIF(r.max_possible_points_calc::numeric, 0),
                0
            ) * 100,
            2
        ),
